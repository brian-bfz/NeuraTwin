...
def extract_episodes(input_file, output_file):
    ...
    with h5py.File(input_file, 'r') as f_in:
        with h5py.File(output_file, 'w') as f_out:
            ...
            # Extract episodes 0-599 (keep original numbering)
            print("Extracting episodes 0-2999...")
            for i in range(3000):
...
if __name__ == "__main__":
    input_file = "PhysTwin/generated_data/push.h5"
    output_file = "PhysTwin/generated_data/push_half.h5"
